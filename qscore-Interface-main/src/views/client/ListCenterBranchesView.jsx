...
const ListCenterBranchesView = () => {
  ...
  const customColumns = [
    ...
    { title: "Address (Q-Plate No)", dataIndex: "number" },
    { title: "Branch Manager", dataIndex: "name" },
    { title: "Email", dataIndex: "email" },
    { title: "No of Staff", dataIndex: "number" },
...
export default ListCenterBranchesView;
