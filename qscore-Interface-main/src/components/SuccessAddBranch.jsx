...
import "./SuccessAddBranch.css"; // Importing the CSS for styling
import Button from "./Button"; // Ensure correct capitalization and path

const SuccessAddBranch = ({ onClose }) => {
      ...
      <div className="success-message-container">
        <div className="text-container">
          ...
          <p className="second-text">
            Inspection center branch added successfully.
          </p>
        </div>
        <Button
          text="Ok" // Button text
...
export default SuccessAddBranch;
